document.addEventListener('DOMContentLoaded', () => {
    ...
    const bentoDictionary = [
        ...
        {
            keywords: ['ちくわ天', 'いそべ揚げ', '磯辺揚げ'],
            data: {
                ingredients: 'ちくわ（国内製造）、小麦粉、植物油脂、青のり、でん粉、食塩／加工デンプン、調味料（アミノ酸等）、（一部に小麦・大豆を含む）',
                calories: '180', protein: '6.5', fat: '10.0', carb: '16.0', salt: '1.2', price: '150',
                category: '惣菜'
            }
        },
        {
            keywords: ['とり天', '鶏天', 'たれ付きとり天'],
            data: {
                ingredients: '鶏肉（ブラジル産）、小麦粉、卵、澱粉、植物油脂、醤油、おろしにんにく、おろし生姜、食塩、胡椒／調味料（アミノ酸等）、パプリカ色素、（一部に小麦・卵・鶏肉・大豆を含む）',
                calories: '320', protein: '18.5', fat: '18.0', carb: '15.0', salt: '1.5', price: '350',
                category: '惣菜'
            }
        },
        {
            keywords: ['まいたけ天', 'マイタケ天', '舞茸天'],
            data: {
                ingredients: 'まいたけ（国産）、小麦粉、卵、澱粉、植物油脂、食塩／膨張剤、（一部に小麦・卵を含む）',
                calories: '120', protein: '2.5', fat: '8.5', carb: '10.0', salt: '0.4', price: '200',
                category: '惣菜'
            }
        },
        {
            keywords: ['せり天', 'セリ天'],
            data: {
                ingredients: 'せり（国産）、小麦粉、卵、澱粉、植物油脂、食塩／膨張剤、（一部に小麦・卵を含む）',
                calories: '90', protein: '1.8', fat: '6.0', carb: '8.5', salt: '0.3', price: '180',
                category: '惣菜'
            }
        },
        {
            keywords: ['たけのこ天', '筍天', '竹の子天'],
            data: {
                ingredients: '竹の子（国産）、小麦粉、卵、澱粉、植物油脂、醤油、かつおだし、食塩／膨張剤、（一部に小麦・卵・大豆を含む）',
                calories: '110', protein: '2.2', fat: '7.5', carb: '11.0', salt: '0.6', price: '220',
                category: '惣菜'
            }
        },
        {
            keywords: ['とり天弁当'],
            data: {
                ingredients: '麦入り御飯（米（国産）、大麦）、とり天（鶏肉（ブラジル産）、小麦粉、卵、等）、その他おかず、天ぷらつゆ／調味料（アミノ酸等）、（一部に小麦・卵・鶏肉・大豆を含む）',
                calories: '780', protein: '24.0', fat: '28.0', carb: '102.0', salt: '3.8', price: '600',
                category: '弁当'
            }
        },
        {
        ...
        // ==== 中華・その他 ====
        {
            ...
            data: {
                ingredients: 'えび（バナメイ産）、玉ねぎ、トマトケチャップ、豆板醤、醤油、砂糖、みりん、生姜、にんにく、片栗粉／調味料（アミノ酸等）、（一部にえび・小麦・大豆を含む）',
                calories: '320', protein: '12.0', fat: '18.0', carb: '22.0', salt: '2.5', price: '450',
                category: '惣菜'
            }
        },
        {
            keywords: ['エビマヨ', 'えびマヨ', '海老マヨネーズ'],
            data: {
                ingredients: 'えび（バナメイ産）、マヨネーズソース（マヨネーズ、砂糖、練乳、ケチャップ等）、卵、植物油脂、澱粉、食塩／調味料（アミノ酸等）、香辛料抽出物、（一部に小麦・卵・乳成分・えび・大豆・りんごを含む）',
                calories: '420', protein: '14.5', fat: '32.0', carb: '15.0', salt: '1.8', price: '480',
                category: '惣菜'
            }
        },
        {
        ...
        },
        {
            keywords: ['赤飯'],
            data: {
                ingredients: 'もち米（国産）、小豆（国産）、食塩、ごま／着色料（紅麹）、（一部にごまを含む）',
                calories: '350', protein: '7.5', fat: '1.5', carb: '75.0', salt: '1.2', price: '300',
                category: '弁当'
            }
        },
        {
            keywords: ['鶏おこわ', 'とりおこわ'],
            data: {
                ingredients: 'もち米（国産）、鶏肉（ブラジル産）、人参、椎茸、醤油、砂糖、みりん、風味調味料／調味料（アミノ酸等）、（一部に小麦・鶏肉・大豆を含む）',
                calories: '420', protein: '12.0', fat: '8.0', carb: '75.0', salt: '2.5', price: '450',
                category: '弁当'
            }
        },
        {
            keywords: ['中華おこわ'],
            data: {
                ingredients: 'もち米（国産）、豚肉、椎茸、竹の子、干し海老、ごま油、醤油、オイスターソース、砂糖、酒／調味料（アミノ酸等）、（一部に小麦・えび・豚肉・大豆・ごまを含む）',
                calories: '450', protein: '13.5', fat: '12.0', carb: '72.0', salt: '2.8', price: '500',
                category: '弁当'
            }
        },
        {
            keywords: ['栗おこわ', '栗御飯'],
            data: {
                ingredients: 'もち米（国産）、栗（国産または中国産）、食塩、砂糖、みりん、酒／着色料（クチナシ）、（一部に大豆を含む）',
                calories: '380', protein: '6.5', fat: '1.0', carb: '85.0', salt: '1.5', price: '500',
                category: '弁当'
            }
        },
        {
            keywords: ['さくらおこわ', '桜おこわ'],
            data: {
                ingredients: 'もち米（国産）、桜の花塩漬け、桜の葉、食塩、みりん、酒／着色料（赤106）、（一部に大豆を含む）',
                calories: '340', protein: '6.0', fat: '0.8', carb: '77.0', salt: '2.2', price: '450',
                category: '弁当'
            }
        },
        {
            keywords: ['たけのこおこわ', '筍おこわ'],
            data: {
                ingredients: 'もち米（国産）、竹の子（国産または中国産）、油揚げ、人参、醤油、みりん、風味調味料／調味料（アミノ酸等）、（一部に小麦・大豆を含む）',
                calories: '360', protein: '8.0', fat: '4.5', carb: '72.0', salt: '2.4', price: '480',
                category: '弁当'
            }
        },
        {
            keywords: ['ちまき', '中華ちまき'],
            data: {
                ingredients: 'もち米（国産）、豚肉、竹の子、椎茸、植物油脂、醤油、砂糖、オイスターソース、葱油、食塩、竹の皮／調味料（アミノ酸等）、（一部に小麦・豚肉・大豆・ごまを含む）',
                calories: '280', protein: '8.5', fat: '9.0', carb: '42.0', salt: '1.8', price: '250',
                category: '惣菜'
            }
        },
        // ==== 各国料理 ====
